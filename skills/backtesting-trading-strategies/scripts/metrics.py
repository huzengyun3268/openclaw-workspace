...
鈺?           BACKTEST RESULTS: {result.strategy.upper():^20}              鈺?鈺?           {result.symbol} | {result.start_date.strftime('%Y-%m-%d')} to {result.end_date.strftime('%Y-%m-%d')}             鈺?鈺犫晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暎
鈺?PERFORMANCE                          鈹?RISK                          鈺?鈺?鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹尖攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€  鈺?鈺?Total Return:     {result.total_return:>+10.2f}%         鈹?Max Drawdown:   {result.max_drawdown:>+10.2f}%    鈺?鈺?CAGR:             {result.cagr:>+10.2f}%         鈹?VaR (95%):      {result.var_95:>+10.2f}%    鈺?鈺?Sharpe Ratio:     {result.sharpe_ratio:>10.2f}          鈹?Volatility:     {result.volatility:>10.2f}%    鈺?鈺?Sortino Ratio:    {result.sortino_ratio:>10.2f}          鈹?Ulcer Index:    {result.ulcer_index:>10.2f}     鈺?鈺?Calmar Ratio:     {result.calmar_ratio:>10.2f}          鈹?CVaR (95%):     {result.cvar_95:>+10.2f}%    鈺?鈺犫晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暎
鈺?TRADE STATISTICS                                                     鈺?鈺?鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈺?鈺?Total Trades:     {result.total_trades:>10}          鈹?Profit Factor:  {result.profit_factor:>10.2f}     鈺?鈺?Win Rate:         {result.win_rate:>10.1f}%         鈹?Expectancy:     ${result.expectancy:>10.2f}    鈺?鈺?Avg Win:          ${result.avg_win:>10.2f}         鈹?Max Consec. Losses: {result.max_consecutive_losses:>5}    鈺?鈺?Avg Loss:         ${result.avg_loss:>10.2f}         鈹?Avg Duration:   {result.avg_trade_duration:>10}     鈺?鈺犫晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暎
鈺?Capital: ${result.initial_capital:,.0f} 鈫?${result.final_capital:,.0f}                                  鈺?鈺?Parameters: {params_str:<56} 鈺?鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暆
"""
