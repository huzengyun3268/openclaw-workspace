...
# Sina API field indices (verified):
# fields[0]=name, fields[1]=yesterday_close, fields[2]=open, fields[3]=current, fields[4]=high, fields[5]=low
codes = [
...
try:
    ...
    for line in content.strip().split('\n'):
        ...
        results[var] = {'price': price, 'prev': prev_close, 'chg': chg}
